...
let str = `
*ミ💖 𝙷𝙾𝙻𝙰 ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 𝙱𝙾𝚃𝙿𝙾𝙻𝙺𝙰 💖彡*
...
handler.command = /^(menu|menú|memu|memú|help|info|comandos|allmenu|2help|menu1.2|comandos|commands|commandos)$/i
handler.exp = 50
handler.fail = null
